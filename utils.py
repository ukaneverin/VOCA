...
def remove_non_assigned(pred_map, gt, num_classes, r=6):
    pair_distances = []
...
def calc_f1(gt, pred_map, num_classes, r=6):
    ...
    pred_map, pair_distances = remove_non_assigned(pred_map, gt, num_classes, r)
